<?php
	...
	function calcularEdadTexto($fecha, $semanasprematuro)
    {
		...
		if($semanasprematuro>0){
			$meses=$interval->format('%m') + ($interval->y * 12)+round((40-$semanasprematuro)/4-.005,0);
		}else{
			$meses=$interval->format('%m') + ($interval->y * 12);
		}
						...
						<table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
							<tr>
								<td>
									...
									<button> 
										<a href="'.$link.'" style="color:white;text-decoration:none">'.$textolink.'</a>
									</button>
								</td> 
							</tr>
							<tr>
								<td>
									<p style="color:white; font-size:14px">En caso que el bot&oacute;n no sirva, copia y pega el siguiente link:</p>
									<p style="color:white; font-size:10px">'.$link.'</p>
								</td>
							</tr>
						</table>
					</div>
