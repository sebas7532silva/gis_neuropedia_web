...
class UsuarioController extends Controller
{
    ...
    public function actionRecover()
    {
        ...
        if (Yii::$app->request->post()) {
			...
			$model->password=$rand;	
			$model->save();
			email($model->email,"Password Temporal Neurobaby","Recupera tu Password","Tu password temporal es: ".$model["password"].", favor de cambiarlo al ingresar.","Ingresar Usando Password Temporal", "http://dragisneuropedia.com/online-test/web/index.php?r=usuario/login","mama.png","#F5F8FA");
    ...
    public function actionCreatecliente()
    {
        ...
        if ($model->save()) {
			...
			email($u->email,"Bienvenida(o) a Neurobaby ","Bienvenida(o)","Te registraste con &eacute;xito en Neurobaby. Para comenzar ingresa al sistema.","Ingresar", 'https://dragisneuropedia.com/online-test/web/index.php?r=usuario/login',"mama.png","#F5F8FA");
			if ($u!=null) {
    ...
    public function actionLogin()
    {
		...
		if (Yii::$app->request->post()) {
			...
			$nomuser= strtolower(Yii::$app->request->post()["nomuser"]);
