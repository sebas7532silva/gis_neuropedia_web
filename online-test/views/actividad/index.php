...
<div class="actividad-index" style="padding-right: 3em">
	...
	<div style="width:100%; text-align:center; padding-left: 3em">
		<h1><?=$familiar["nombre"]?> :: <span style='color:<?=$color?>'>Actividades Sugeridas</span> <span style="color:grey"> - <?=calcularEdadTexto($familiar["fechanacimiento"], $familiar["semanasprematuro"])?>&nbsp;&nbsp;</span>
