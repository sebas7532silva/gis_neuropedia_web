...
<div class="preguntausuariorespuesta-create" style="margin-top:2em;">
    ...
    <h2 style="font-size:3em; margin-bottom: 0.5em"><?=$familiar["nombre"]?> :: <span style="color: <?=$color?>">Respuestas </span><span style="color: grey"> - <?=$age["edad"]?> </span></h2>
	...
	<table style="width: 90%; border-collapse: separate; ">
		...
		<?php
			...
			foreach($fh as $h){
				...
				if($h["pregunta"]["competencia"]["competencia_id"]!=1){
				echo "<tr style='background-color: ".$alter."'>";
					echo "<td style='".$tdstylel."'>".$h["pregunta"]["competencia"]["competencia"]."</td>";
