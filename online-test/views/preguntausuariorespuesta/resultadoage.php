...
<div class="preguntausuariorespuesta-create">
	...
	<div style="margin-top:2em; width=100%; text-align: center;">
		...
		<a href="index.php?r=actividad%2Findex&familiarid=<?=$familiar["familiar_id"]?>">
			<div style="margin-left: 1em; padding-left: 2em;border: 3px solid <?=$color?>;width: 14em;float: left;text-align: center;border-radius: 2em;padding-right: 2em;padding-top: 1em;padding-bottom: 1em; color: white; background-color: <?=$color?>">
	...
	<div style="margin-top:2em; width=100%; text-align: center;">
		<a href="index.php?r=familiar/index">
			<div style="padding-left: 2em;border: 3px solid <?=$color?>;width: 10em;float: left;text-align: center;border-radius: 2em;padding-right: 2em;padding-top: 1em;padding-bottom: 1em; color: white; font-weight: normal; background-color: <?=$color?>">
				Regresar
			</div>
		</a>
	</div>
