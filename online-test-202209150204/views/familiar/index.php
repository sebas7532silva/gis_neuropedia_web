...
<div class="familiar-index">
	<?php
		...
		if($_SESSION["horasdisponibles"]==0){
			...
			echo "<p style='font-size: 1.5em'>El precio por introducción es de $ ".($stripeDetails["precioLoginNeurobaby"]/100)." MXN e incluye a 2 niños desde sus 2 meses hasta sus 5 años. </p>";
			echo "<hr>";
	?>
		<div class="row">
			<div class="col-md-12">
				<div class="form-container">
					<form autocomplete="off" action="index.php?r=pago%2Fcreate" 	method="POST">			   				
						...
						data-amount="<?=$stripeDetails["precioLoginNeurobaby"]?>"
						data-name="Neurobaby"
			...
			<div style="margin-top:1em; margin-bottom:1em; background-color: white; color: black; padding: 1em; border-radius: 1em">
				<div style="margin-bottom:1em; font-weight: 800; font-size: 2em">
					<div style="margin-right:2em">
						<?=$miembro["nombre"]?>&nbsp;<span style="font-weight: 400; color: grey">(<?=calcularEdadTexto($miembro["fechanacimiento"])?>)</span>&nbsp;<a href="index.php?r=familiar/update&id=<?=$miembro["familiar_id"]?>" title="Cambiar Datos" style="text-decoration:none;"><img src="../web/images/pencil.svg" style="width:0.75em; vertical-align: baseline;"></a>
					</div>
				</div>			
