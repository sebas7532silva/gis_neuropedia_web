...
class UsuarioController extends Controller
{
    ...
    public function actionRecover()
    {
        ...
        if (Yii::$app->request->post()) {
			...
			$model->password=$rand;	
			$model->save();
			email($model->email,"Password Temporal Neurobaby","Recupra tu Password","Tu password temporal es: ".$model["password"].", favor de cambiarlo al ingresar.","Ingresar Usando Password Temporal", "http://dragisneuropedia.com/online-test/web/index.php?r=usuario/login","mama.png","#F5F8FA");
