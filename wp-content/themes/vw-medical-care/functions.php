...
function vw_medical_care_scripts() {
	...
	wp_add_inline_style( 'vw-medical-care-basic-style',$custom_css );
...
define('VW_MEDICAL_CARE_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-medical-care/','vw-medical-care');
define('VW_MEDICAL_CARE_SUPPORT','https://wordpress.org/support/theme/vw-medical-care/','vw-medical-care');
define('VW_MEDICAL_CARE_REVIEW','https://wordpress.org/support/theme/vw-medical-care/reviews','vw-medical-care');
define('VW_MEDICAL_CARE_BUY_NOW','https://www.vwthemes.com/themes/medical-wordpress-theme/','vw-medical-care');
define('VW_MEDICAL_CARE_LIVE_DEMO','https://www.vwthemes.net/vw-medical-care-pro/','vw-medical-care');
define('VW_MEDICAL_CARE_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-medical-care-pro/','vw-medical-care');
define('VW_MEDICAL_CARE_FAQ','https://www.vwthemes.com/faqs/','vw-medical-care');
define('VW_MEDICAL_CARE_CONTACT','https://www.vwthemes.com/contact/','vw-medical-care');
define('VW_MEDICAL_CARE_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-medical-care');
